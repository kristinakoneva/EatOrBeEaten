...
Има еден конструктор со два параметри - ширината и висината на прозорецот. Во конструкторот се иницијализираат листата од топчиња и Random објектот, главното топче се посатвува на null, бројот на погодени топчиња, за почеток, се посатвува на нула и двете boolean променливи се поставуваат на false.
## Form1.cs
## NewGame.cs
